...
public class UnitTest1
{
    ...
    public UnitTest1()
    {
        customers = new List<object>()
        {
            new
            {
                name = "Mika Huber", financialProducts = new List<object>()
                {
                    new
                    {
                        balance = 200.0
            ...
            new
            {
                name = "Alexander Kauper", financialProducts = new List<object>()
                {
                    new
                    {
                        balance = 250.0
        ...
        var pact = Pact.V3("Consumer2", "CustomerAPI", config);
